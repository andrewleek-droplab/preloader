...
var LoaderBlob = require('./loaders/LoaderBlob');
var LoaderArrayBuffer = require('./loaders/LoaderArrayBuffer');
...
var Preloader = new Class({
  ...
  */
  ...
  /**
  *
  *Load arraybuffer - uses the LoaderArrayBuffer loader
  *
  * @method addArrayBuffer
  * @param {String} url Base URL of asset
  *
  */
  addArrayBuffer: function (url, options) {
    this.addFromLoaderType(url, LoaderArrayBuffer, options);
  },

  /**
  *
  *Load blob - uses the LoaderBlob loader
  *
  * @method addBlob
  * @param {String} url Base URL of asset
  *
  */
  addBlob: function (url, options) {
    this.addFromLoaderType(url, LoaderBlob, options);
  },
